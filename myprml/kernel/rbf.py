...
class RBF(Kernel):
    def __init__(self, params):
        ...
        :param params: (ndim + 1,) ndarray   parameters of radial basis function
    ...
    def __call__(self, x, y, pairwise=True):
        ...
        :param x:  ndarray [..., ndim]   input of this kernel function
        :param y: ndarray [..., ndim]     another input
        :param pairwise:
        :return: output of this radial basis function
        """
