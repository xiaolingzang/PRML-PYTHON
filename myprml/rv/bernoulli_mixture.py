...
class BernoulliMixture(RandomVariable):
    ...
    def __init__(self, n_components=3, mu=None, coef=None):
        ...
        :param n_components:   number of bernoulli component
        :param mu:  probability of value 1 for each component
        :param coef: mixing coefficients
        """
        super().__init__()
    ...
    def classify(self, X):
        ...
        :param X:(sample_size, ndim) ndarray  input
        :return:corresponding cluster index
        """
        return np.argmax(self.classfiy_proba(X), axis=1)
    ...
    def classfiy_proba(self, X):
        ...
        p(z|x,theta)
        :param X:
        :return: posterior probability of cluster
        """
