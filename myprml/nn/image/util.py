...
def img2patch(img, size, step=1):
    ...
    :param img: (n_batch, xlen_in, ylen_in, in_channels) ndarray batch of images
    :param size: patch size
    :param step: tuple or int  stride of patches
    :return: (n_batch, xlen_out, ylen_out, size, size, in_channels) ndarray
...
def patch2img(x, stride, shape):
    ...
    :param x: (n_batch, xlen_in, ylen_in, kx, ky, in_channels) ndarray
        batch of patches at all points
    :param stride: tuple  applied stride to toke patch
    :param shape: (n_batch, xlen_out, ylen_out, in_channels) tuple   output image shape
    :return: (n_batch, len_out, ylen_out, in_channels) ndarray
        images
    """
