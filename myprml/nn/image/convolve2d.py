...
from myprml.nn.image.util import img2patch,patch2img

class Convolve2d(Function):
    def __init__(self,stride,pad):
        """
        construct 2 dimensional convolution function
        :param stride: int or tuple of ints   stride of kernel application
        :param pad: int or tuple of ints    padding image
        """
    ...
    def _check_input(self,x,y):
        ...
        if x.shape[3]!=y.shape[2]:
            raise ValueError(
                "shape {} and {} not aligned:{} (dim 3)!={} (dim2)"
            )
        return x,y
