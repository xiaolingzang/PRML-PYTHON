...
class RandomVariable(Function):
    ...
    def __init__(self, data=None, p=None):
        ...
        :param data:  tensor_like   observed data
        :param p: RandomVariable    original distribution of a model
    ...
    def draw(self):
        """
        enerate a sample
        :return: tensor   sample generated from this random variable
        """
        if self.observed:
    ...
    def pdf(self, x=None):
        ...
        :param x: tensor_like   observed data
        :return: Tensor    value of probability density function for each input
        """
    ...
    def log_pdf(self, x=None):
        ...
        :param x: tensor_like  observed data
        :return:  Tensor  logarithm of probability density function
        """
