import numpy as np
from myprml.nn.optimizer.optimizer import Optimizer
...
class Adam(Optimizer):
    ...
    def __init__(self, parameter, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8):
        ...
        :param parameter: list of parameters to be optimized
        :param learning_rate:  float
        :param beta1: exponential decay rate for the 1st moment
        :param beta2: exponential decay rate for the 2nd moment
        :param epsilon: small constant to be added to denominator for numerical stability

        n_iter:number of iterations performed
        moment1:1st moment of each learnable parameter
        moment2:2nd moment of each learnable parameter
        """
    ...
    def update(self):
        """
        update parameter of neural network
        :param self:
        :return:
        """
