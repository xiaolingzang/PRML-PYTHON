...
class HiddenMarkovModel(object):
    ...
    def __init__(self, initial_proba, transition_proba):
        ...
        :param initial_proba: (n_hidden,) np.ndarray   initial probability of each hidden state
        :param transition_proba: (n_hidden, n_hidden) np.ndarray
    ...
    def expect(self, seq):
        ...
        for like, c in zip(likelihood[-1:0:-1], constant[-1:0:-1]):
            print(self.transition_proba)
            print(like * backward[0])
            print(c)
